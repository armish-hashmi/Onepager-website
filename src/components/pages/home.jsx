...
const PORTFOLIO_DATA = [
  { id: 1, category: ["Web Design","Photography"], image: "src/components/img/1.jpg" },
  { id: 2, category: ["Illustration","Branding"], image: "src/components/img/2.jpg" },
  { id: 3, category: ["Photography", "Illustration"], image: "src/components/img/3.jpg" },
  { id: 4, category: ["Web Design"," Branding"], image: "src/components/img/4.jpg" },
  { id: 5, category: ["Photography"], image: "src/components/img/5.jpg" },
  { id: 6, category: ["Web Design","Photography","Branding"], image: "src/components/img/6.jpg" },
  { id: 7, category: ["Web Design", "Illustration"], image: "src/components/img/7.jpg" },
  { id: 8, category: ["Web Design", "Branding"], image: "src/components/img/8.jpg" },
  { id: 9, category: ["Photography"," Illustration"], image: "src/components/img/9.jpg" },
  { id: 10, category: ["Web Design"], image: "src/components/img/10.jpg" },
  { id: 11, category: ["Web Design ","Photography"], image: "src/components/img/11.jpg" },
];
  ...
  return (
    <div className="onepage-container">
      ...
      <section id="services" className="page-section section-layout" >
        ...
        <h3>CSS3</h3>
        <p>Duis sed odio sit amet nibh vulputate cursus a sit amet mauris morbi accumsan.</p>
        <img src="src/components/img/image.png"></img>
      </section>
